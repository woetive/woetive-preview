...
const PATH = [
  ...
  // Method interlude — dark (430vh–530vh ≈ p 0.265–0.327)
  { p: 0.300, pos: [ 0.65, 1.25, -42.90], look: [ 0.45, 0.85, -45.20], fov: 29, bg: '#050505', mp: [ 0.85, -0.95, -45.20], mr: -0.35, ms: 2.65, pa: 0.10, li: 1.20 },

  // Method header — WHITE bg under "How we direct.", figure pulled out of frame
  { p: 0.340, pos: [ 0.10, 1.50, -50.00], look: [ 0.00, 1.20, -55.00], fov: 36, bg: '#F4F3EE', mp: [ 0.00, -1.00, -55.00], mr:  0.00, ms: 2.10, pa: 0.00, li: 0.40 },
  { p: 0.362, pos: [ 0.10, 1.50, -50.00], look: [ 0.00, 1.20, -55.00], fov: 36, bg: '#F4F3EE', mp: [ 0.00, -1.00, -55.00], mr:  0.00, ms: 2.10, pa: 0.00, li: 0.40 },

  // Method steps — fixed framing for all 4 (head + chest visible). No descent.
  // Only model rotation increments to imply slow turn while reading each step.
  { p: 0.395, pos: [ 0.10, 1.60, -51.50], look: [ 0.00, 1.30, -55.00], fov: 32, bg: '#050505', mp: [ 0.00, -1.00, -55.00], mr:  0.00, ms: 2.10, pa: 0.05, li: 0.85 },
  { p: 0.457, pos: [ 0.10, 1.60, -51.50], look: [ 0.00, 1.30, -55.00], fov: 32, bg: '#050505', mp: [ 0.00, -1.00, -55.00], mr:  0.15, ms: 2.10, pa: 0.05, li: 0.85 },
  { p: 0.519, pos: [ 0.10, 1.60, -51.50], look: [ 0.00, 1.30, -55.00], fov: 32, bg: '#050505', mp: [ 0.00, -1.00, -55.00], mr:  0.30, ms: 2.10, pa: 0.05, li: 0.85 },
  { p: 0.580, pos: [ 0.10, 1.60, -51.50], look: [ 0.00, 1.30, -55.00], fov: 32, bg: '#050505', mp: [ 0.00, -1.00, -55.00], mr:  0.45, ms: 2.10, pa: 0.05, li: 0.85 },
